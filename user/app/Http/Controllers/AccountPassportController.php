...
use App\Models\AccountPassport;
...
class AccountPassportController extends Controller
{
        ...
        public function passport(Request $request){
            ...
            try {
                ...
                $recordUpdate = [
                    ...
                    if (!$fileexist['status']) {
                        $query = AccountPassport::insert($record);
                        if ($query) {
                        $successful = true;
                        }else{
                        $failed = true;
                        ...
                        $query = AccountPassport::where('userid', '=', $record['userid'])
                                            ->update($recordUpdate);
                        if ($query) {
                        $successful = true;
                        }else{
