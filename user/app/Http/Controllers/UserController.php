...
use App\Http\Requests\UserRequestBatch;
...
class UserController extends Controller
{
    ...
    public function manage($id){
        ...
        if ($record['status']=='success') {
            $record = $record['info'];
            return view('apps.user.manage', compact('record'));
        }else{
            $message = [
                "type" => "info",
                "info" => "",
    ...
    public function profile($id){
        ...
        if ($record['status']=='success') {
            $record = $record['info'];
            return view('apps.user.profile', compact('record'));
        }else{
            $message = [
                "type" => "error",
    ...
    public function edit_name($id){
        if (isset($_COOKIE['manageUser']) && ($id === $_COOKIE['manageUser'])) {
            ...
            if ($record['status']=='success') {
                $record = $record['info'];
                return view('apps.user.edit_name', compact('record'));
            }else{
                $message = [
                "type" => "info",
                "info" => "",
    ...
    public function edit_dob($id){
        if (isset($_COOKIE['manageUser']) && ($id === $_COOKIE['manageUser'])) {
            ...
            if ($record['status']=='success') {
                $record = $record['info'];
                return view('apps.user.edit_dob', compact('record'));
            }else{
                $message = [
                "type" => "info",
                "info" => "",
    ...
    public function edit_gender($id){
        if (isset($_COOKIE['manageUser']) && ($id === $_COOKIE['manageUser'])) {
            ...
            if ($record['status']=='success') {
                $record = $record['info'];
                return view('apps.user.edit_gender', compact('record'));
            }else{
                $message = [
                "type" => "info",
                "info" => "",
    ...
    public function edit_contact_address($id){
        if (isset($_COOKIE['manageUser']) && ($id === $_COOKIE['manageUser'])) {
            ...
            if ($record['status']=='success') {
                $record = $record['info'];
                return view('apps.user.edit_contact_address', compact('record'));
            }else{
                $message = [
                "type" => "info",
                "info" => "",
    ...
    public function edit_phone($id){
        if (isset($_COOKIE['manageUser']) && ($id === $_COOKIE['manageUser'])) {
            ...
            if ($record['status']=='success') {
                $record = $record['info'];
                return view('apps.user.edit_phone', compact('record'));
            }else{
                $message = [
                "type" => "info",
                "info" => "",
    ...
    public function edit_password($id){
        if (isset($_COOKIE['manageUser']) && ($id === $_COOKIE['manageUser'])) {
            ...
            if ($record['status']=='success') {
                $record = $record['info'];
                return view('apps.user.edit_password', compact('record'));
            }else{
                $message = [
                "type" => "info",
                "info" => "",
    ...
    public function list(){
        return view('apps.user.record');
    }

    public function uploadBatch(){
        return view('apps.user.upload_record');
    }

    public function createRecord(){
        return view('apps.user.new_record');
    }

    public function checkIfIdIsValid($data){
        $query = User::where('deleted_status', '=', '0')
    ...
    public function record($id)
    {
        ...
        $query = User::from('user_record as t1')
                    ...
                    ->leftJoin('user_passport as t6', 't6.userid', '=', 't1.id')
    ...
    public function upload(UserRequestBatch $request){
    try {
        $records = [];
        $exist = [];
        $noRecord = [];
...
// End loop
    ...
    try {
        ...
        $update = User::where('generated_id', '=', $id)
                            ->update($row);
...
$query = User::where('generated_id', '=', $id)
