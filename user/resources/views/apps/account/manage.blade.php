   ...
   <!-- Please note that, these are just default components, 
    ...
    <div class="container-fluid">
        ...
        <!-- Body component(s) -->
           ...
           <account_passport :server_record="{{ session('record') ?? $record ?? json_encode('') }}"> </account_passport>
           <manage_account :server_message="{{ session('message') ?? $message ?? json_encode('') }}" :server_record="{{ session('record') ?? $record ?? json_encode('') }}"></manage_account>
           <!-- <delete_account :server_record="{{ session('record') ?? $record ?? json_encode('') }}"> </delete_account> -->
    </div>
