  ...
  @section('pageTitle', 'Password reset mailing')
  @section('content')
  <div class="container">
    <div>
      <h2 class="">{{$title}}.</h2>
      <p class="mt-3">Dear, <span class="text-capitalize">{{$name}}.</span> </p>  
      <p>A request to reset or create a password for your {{$fromName}} account ({{$email}}) was made. if this request was made by you, use the reset link below to continue your password reset.
