...
<div class="container-fluid">
    <a href="#" id="topLink"></a>
        ...
        <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#newAccessGroupModal">New <i class="bi bi-plus-circle"></i></button>
...
resetForm: function(){
   ...
   validateForm: function(){
    ...
    sendForm: function(){
        ...
        axios.post('/accessgroup/create', form).then(response => {
    ...
    manageStatus: function(){
        ...
        $(".toaster").toast('hide')
        this.showOverlay=true;
        axios.get('/accessgroup/status/updatebatch', {params:this.parameters}).then(response => {
            this.button=this.btntxt;
            this.showOverlay=false;
            this.errors = '';
             if((response.status != undefined && response.status==200) && (response['data'].data.status==response['data'].data.statusmsg)){
