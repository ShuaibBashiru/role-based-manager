...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="mt-1 mb-2">
            <h5 class="mt-2 ms-0 text-muted"><i class="bi bi-chevron-left text-primary" onclick="history.back()" title="Go back" role="button"></i> <span v-text="pageName"></span></h5>
        </div>
        </div>
...
<div class="col-md-12 content">
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            ...
            <div class="col-md-3"><p class="text-capitalize p-1 m-0"><a class="btn-link" href="#" data-bs-toggle="modal" data-bs-target="#editAccessGroupModal"><span class="text-primary float-end"> <u>Edit</u> </span></a></p></div>
        </div>
        </div>
...
export default {
    ...
    manageStatus: function(){
        ...
        axios.get('/accessgroup/manage/status', {params:this.parameters}).then(response => {
            this.button=this.btntxt;
            this.showOverlay=false;
            this.errors = '';
