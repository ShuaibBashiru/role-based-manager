...
<div class="container-fluid">
    <a href="#" id="topLink"></a>
            ...
            <div class="col-md-6">
            <div class="mt-1 mb-2">
            <h5 class="mt-2 ms-0 text-success"> <span v-text="pageName" onclick="history.back()" role="button"></span>  <span class="text-muted bi bi-chevron-right"> Upload</span> </h5>
            </div>
            </div>
            ...
            <button type="button" class="btn btn-outline-primary" onclick="location.href='create'"> Create <i class="bi bi-plus-circle"></i></button>
...
<div class="col-md-12">
    ...
    <table class="table table-hover table-bordered" id="myTable">
        ...
        <tr>
            ...
            <th scope="col" class="text-truncate" @click="sortOrder('email_one')" title="">Email </th>
            <th scope="col" class="text-truncate" @click="sortOrder('phone_one')" title="">Phone </th>
            <th scope="col" class="text-truncate" @click="sortOrder('gender_id')" title="">Gender </th>
            <th scope="col" class="text-truncate" @click="sortOrder('date_of_birth')" title="">DOB </th>
...
export default {
    name: 'AccessGroup_Upload',
    props: ['server_message'],
    data (){
        return{
        pageName: 'Access Group',
        alertTitle: '',
        alertMsg: '',
        showOverlay: false,
        notification: '',
   ...
   showMore: function(){
    ...
    sendForm: function(){
        ...
        axios.post('/admin/upload', this.parameters).then(response => {
