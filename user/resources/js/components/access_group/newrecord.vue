...
<div class="modal fade" id="newAccessGroupModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="newAccessGroupModalLabel" aria-hkeyden="true">
<div class="modal-dialog ps-md-3 pe-md-3">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-dark" id="newAccessGroupModalLabel" v-html="pageName"></h5>
    ...
    <div class="col-md-12 mt-1">
        <div class="m-1 mt-3">
                ...
                <div class="input-group">
                    <input type="text" v-model="parameters.group_name" @keyup="noSpace('group_name')" id="group_name" minlength="3" maxlength="40" class="shadow-none form-control form-control-md form-control-sm-lg" required placeholder="Enter here" :disabled="disabled">
                </div>
