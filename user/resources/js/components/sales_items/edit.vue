...
<div class="modal-dialog ps-md-3 pe-md-3">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-dark" id="editSalesItemsModalLabel" v-html="pageName"></h5>
...
<div class="col-12 m-0 p-0">
    ...
    <div class="col-md-12 mt-1">
        <div class="m-1 mt-3">
                   <label for="item_name" class="text-muted">Title</label>
                <div class="input-group">
                    <input type="text" v-model="parameters.item_name" @keyup="oneSpace('item_name')" id="item_name" minlength="3" maxlength="100" class="shadow-none form-control form-control-md form-control-sm-lg" required placeholder="Enter here" :disabled="disabled" readonly>
                </div>
                <span class="text-danger" for="" v-if="errors.item_name && errors.item_name != ''"><small> <span v-text="errors.item_name[0]"></span> </small></span>
                </div>
  </div>
      <div class="col-md-12 mt-1">
        <div class="m-1 mt-3">
...
export default {
    ...
    methods:{
        getRecords: function(){
            this.parameters.item_name = this.info.item_name;
            this.parameters.unit_price = this.info.unit_price;
  ...
  checkIfChanged: function(){
   ...
   validateForm: function(){
    ...
    sendForm: function(){
        ...
        axios.post('/salesitems/update', form).then(response => {
