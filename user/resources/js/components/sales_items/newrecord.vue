...
<div class="modal-dialog ps-md-3 pe-md-3">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-dark" id="newSalesItemsModalLabel" v-html="pageName"></h5>
    ...
    <div class="col-md-12 mt-1">
        <div class="m-1 mt-3">
                ...
                <div class="input-group">
                    <input type="text" v-model="parameters.item_name" @keyup="oneSpace('item_name')" id="item_name" minlength="3" maxlength="100" class="shadow-none form-control form-control-md form-control-sm-lg" required placeholder="Enter here" :disabled="disabled">
                </div>
