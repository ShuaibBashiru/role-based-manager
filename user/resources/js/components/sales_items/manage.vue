...
<div class="col-md-12 content">
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            ...
            <div class="col-md-9"><p class="text-capitalize p-1 m-0" v-html="info.item_name"></p></div>
        </div>
        </div>
        <div class="list-group-item">
        <div class="row">
            <div class="col-md-3"><p class="text-uppercase p-1 m-0 text-muted"><small>Price</small></p></div>
            <div class="col-md-6"><p class="text-capitalize p-1 m-0" v-html="info.unit_price"></p></div>
        </div>
        </div>
          <div class="list-group-item">
        <div class="row">
          <div class="col-md-12"><p class="text-capitalize p-1 m-0"><a class="btn-link" href="#" data-bs-toggle="modal" data-bs-target="#editSalesItemsModal"><span class="text-primary float-end"> <u>Edit</u> </span></a></p></div>
        </div>
        </div>
        </div>  
        </div>
...
export default {
    ...
    manageStatus: function(){
        ...
        axios.get('/salesitems/manage/status', {params:this.parameters}).then(response => {
            this.button=this.btntxt;
            this.showOverlay=false;
            this.errors = '';
