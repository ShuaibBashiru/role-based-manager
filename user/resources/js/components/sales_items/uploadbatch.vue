...
<div class="col-md-12">
    ...
    <table class="table table-hover table-bordered" id="myTable">
        <thead>
        <tr>
            <th scope="col" class="text-truncate" @click="sortOrder('item')" title="">Item </th>
            <th scope="col" class="text-truncate" @click="sortOrder('price')" title="">Price</th>
        ...
        <tr v-for="(d, index) in info.slice(startNumber, endNumber)" :key="index">
            <td class="col text-truncate" v-html="d.item? d.item : '<em class=text-danger>None</em>'"></td>
            <td class="col text-truncate" v-html="d.price? d.price : '<em class=text-danger>None</em>'"></td>
...
export default {
   ...
   showMore: function(){
    ...
    sendForm: function(){
        ...
        axios.post('/salesitems/upload', this.parameters).then(response => {
