...
<div class="container-fluid">
    ...
    <a href="#" id="topLink"></a>
        ...
        <div class="mt-1 mb-2">
            <h5 class="mt-2 ms-0"> <span class="bi bi-chevron-left" onclick="history.back()" role="button"></span> <span>Manage</span><span class="text-muted">/Account </span> </h5>
        </div>
        </div>
...
<div class="col-md-12">
    ...
    <div class="row">
        <div class="col-md-10">
        <div class="m-3 mb-1">
            <h5 class="display-7 ft-weight-light">My Account <i class="bi bi-chevron-right"></i> <span class="text-capitalize p-1 m-0 text-secondary" v-html="(info.lastname)? info.lastname+' '+info.firstname+' '+info.othername : ''"> </span></h5>
...
<div class="col-md-12">
  ...
  <form @submit.prevent="validateForm" id="formChange">
            <fieldset class="border p-2 pt-0">
                <legend class="w-auto" style="float: none; padding: inherit;"><small>Name</small></legend>
            <div class="row">
            <div class="col-md-12">
            </div>
    ...
    <div class="col-md-4">
        <div class="m-1 mt-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" v-model="parameters.lastname" @keyup="noSpace('lastname')" id="lastname" minlength="3" maxlength="40" class="shadow-none form-control form-control-md form-control-sm-lg" required placeholder="Lastname is your surname" :disabled="disabled" readonly>
                </div>
 ...
 checkIfChanged: function(){
   ...
   validateForm: function(){
    ...
    sendForm: function(){
        ...
        axios.post('/account/name/update', form).then(response => {
