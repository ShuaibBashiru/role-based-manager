...
<div class="col-md-12">
  ...
  <form @submit.prevent="validateForm" id="formChange">
            <fieldset class="border p-2 pt-0">
                <legend class="w-auto" style="float: none; padding: inherit;"><small>Gender</small></legend>
            <div class="row">
            <div class="col-md-12">
            </div>
...
export default {
 ...
 checkIfChanged: function(){
   ...
   validateForm: function(){
        ...
        }if(this.validated && this.checkIfChanged()) {
            this.sendForm()
            this.validated = false
            this.disabled = false;
    ...
    sendForm: function(){
        ...
        axios.post('/account/gender/update', form).then(response => {
