...
<div class="modal-dialog ps-md-3 pe-md-3">
  ...
  <h6 class="" v-text="'Group: '+ (info? info.group_name : '') "></h6>
  <h6 class="" v-text="'Title: '+ (info? info.menu_title : '') "></h6>
  <h6 class="" v-text="'Link: '+ (info? info.routeLink : '') "></h6>
</div>
...
export default {
  ...
  methods:{
    trashItem: function(){
            ...
            axios.delete('/adminmenu/trash', {params:this.parameters}).then(response => {
