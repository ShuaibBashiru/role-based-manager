...
<div class="col-md-12 content">
    ...
    <div class="col-md-12">
        ...
        <div class="list-group-item">
            <div class="row">
            <div class="col-md-3"><p class="text-uppercase p-1 m-0 text-muted"><small>Group</small></p></div>
            <div class="col-md-9"><p class="p-1 m-0" v-html="info.group_name"></p></div>
        </div>
        </div>
        <div class="list-group-item">
            <div class="row">
            <div class="col-md-3"><p class="text-uppercase p-1 m-0 text-muted"><small>Title</small></p></div>
            <div class="col-md-9"><p class="p-1 m-0" v-html="info.menu_title"></p></div>
        </div>
        </div>
        <div class="list-group-item">
            <div class="row">
        ...
        <div class="list-group-item">
        <div class="row">
            <div class="col-md-12"><p class="text-capitalize p-1 m-0"><a class="btn-link" href="#" data-bs-toggle="modal" data-bs-target="#editRoleModal"><span class="text-primary float-end"> <u>Edit</u> </span></a></p></div>
        </div>
        </div>
...
export default {
    ...
    manageStatus: function(){
        ...
        axios.get('/adminmenu/manage/status', {params:this.parameters}).then(response => {
            this.button=this.btntxt;
            this.showOverlay=false;
            this.errors = '';
