...
<div class="modal-dialog ps-md-3 pe-md-3">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-dark" id="editAccessModalLabel" v-html="pageName"></h5>
...
export default {
    ...
    methods:{
        getRecords: function(){
            ...
            this.parameters.descriptions = this.info.descriptions;
            this.parameters.title = this.info.title;
            this.parameters.route_name = this.info.route_name;
  ...
  checkIfChanged: function(){
   ...
   validateForm: function(){
    ...
    sendForm: function(){
        ...
        axios.post('/access/update', form).then(response => {
